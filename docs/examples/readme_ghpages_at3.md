...
### INPUT/PROMPT
The following prompt was executed recursively using the `AT3` prompt strategy (one sub-task at a time) and targeted the `GPT-4o` mmodel.
...
The following output was generated by applying all 3 phases of the `AT3` prompt strategy:
